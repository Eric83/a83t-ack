...
static DEVICE_ATTR(base, 0666, chip_base_show, NULL);
...
static DEVICE_ATTR(label, 0666, chip_label_show, NULL);
...
static DEVICE_ATTR(ngpio, 0666, chip_ngpio_show, NULL);
