...
//char boot_mode = ICN85XX_WITH_FLASH;
 char boot_mode = ICN85XX_WITHOUT_FLASH;
...
int  icn85xx_fw_update(void *fw)
{
    ...
    flash_info("icn85xx_fw_download start22222222\n");
...
//    msleep(1);
   ...
   flash_info("icn85xx_fw_download ok 444444444\n");
    ...
    //    return R_PROGRAM_ERR;
        ...
        {
            flash_info("read flash data ok1111111, crc ok\n");
        }
        while((FlashState(0)&0x01));
