...
#endif
#define vfe_dev_err(x,arg...) printk("[ev76c570]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[ev76c570]"x,##arg)
...
#define V4L2_IDENT_SENSOR 0x0900
...
static struct ev76c570_reg sensor_sxga_regs[] = {
	...
	{EV76C570_16BIT, 0x12, 0x007E},	/* roi1_0l_1, (1212-960)/2=126 */
	//{EV76C570_16BIT, 0x13, 0x0400},
	{EV76C570_16BIT, 0x13, 0x03C0},	/* roi1_h_1, 960 */
	{EV76C570_16BIT, 0x14, 0x00A6},	/* roi1_0c_1, (1612-1280)/2=166 */
	//{EV76C570_16BIT, 0x15, 0x0500},
	{EV76C570_16BIT, 0x15, 0x0500},	/* roi1_w_1, 1280 */
...
static int sensor_s_exp(struct v4l2_subdev *sd, unsigned int exp_time)
{
	...
	/* exposure time < 80, max frame rate 12fps;
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
	...
	info->focus_status = 0;
	info->low_speed = 0;
	info->width = EV76C570_WIDTH;
	info->height = EV76C570_HEIGHT;
	info->hflip = 0;
	info->vflip = 0;
	info->gain = 0;
