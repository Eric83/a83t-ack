...
int pin_config_get_pin(const char *dev_name, unsigned pin, unsigned long *config)
{
	struct pinctrl_dev *pctldev;
	int ret;
...
EXPORT_SYMBOL(pin_config_get_pin);

int pin_config_set_pin(const char *dev_name, unsigned pin, unsigned long config)
{
	struct pinctrl_dev *pctldev;
	int ret;
...
EXPORT_SYMBOL(pin_config_set_pin);
